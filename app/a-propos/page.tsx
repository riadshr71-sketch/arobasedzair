      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: '60px 40px' }}>
        ...
        <div style={{ marginBottom: '60px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '22px', margin: 0, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>Notre Histoire</h2>
          </div>
        ...
        <div style={{ marginBottom: '60px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
            <div style={{ width: '4px', height: '24px', background: '#026f5c' }}></div>
            <h2 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '22px', margin: 0, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>Notre Mission</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            {[
              ...
              <div key={item.title} style={{ background: '#0a0f0a', border: '1px solid #0d2a1f', borderRadius: '8px', padding: '20px' }}>
                ...
                <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '13px', fontWeight: 700, textTransform: 'uppercase' as const, letterSpacing: '1px', color: '#f0f5f0', marginBottom: '8px' }}>{item.title}</div>
        ...
        <div style={{ marginBottom: '60px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '24px' }}>
            <div style={{ width: '4px', height: '24px', background: '#026f5c' }}></div>
            <h2 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '22px', margin: 0, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>Arobasedzair en chiffres</h2>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '16px' }}>
            ...
            <div style={{ background: '#0a0f0a', border: '1px solid #0d2a1f', borderRadius: '8px', padding: '28px 20px', textAlign: 'center' as const }}>
              ...
              <div style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '32px', color: '#026f5c', marginBottom: '6px' }}>
        ...
        <div style={{ background: '#026f5c', borderRadius: '8px', padding: '40px', textAlign: 'center' as const }}>
          <h3 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '24px', textTransform: 'uppercase' as const, letterSpacing: '1px', marginBottom: '12px' }}>Collaborations & Partenariats</h3>
