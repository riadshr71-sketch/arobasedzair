  ...
  return (
    <main style={{ background: '#080c08', minHeight: '100vh', color: '#f0f5f0' }}>
      ...
      <div style={{ background: '#060a06', borderBottom: '1px solid #0d2a1f', padding: '48px 40px', textAlign: 'center' as const }}>
        ...
        <h1 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '48px', lineHeight: 1, margin: 0, textTransform: 'uppercase' as const }}>
        ...
        {[
          ...
          <div key={section.titre} style={{ marginBottom: '48px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
              ...
              <h2 style={{ fontFamily: 'Barlow Condensed, sans-serif', fontSize: '18px', margin: 0, textTransform: 'uppercase' as const, letterSpacing: '1px' }}>{section.titre}</h2>
            </div>
